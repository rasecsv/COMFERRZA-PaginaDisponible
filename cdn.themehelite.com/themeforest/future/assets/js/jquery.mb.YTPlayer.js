/* ********** Desactivation of the video on Smartphone and Tablet, for a better experience, your video is replaced by one picture, because the loading of a video with a simple telephone network is often too long ********** */
$(document).ready(function(){
	...
	if( ( onMobile === false ) ) {
			...
			/* the class for your picture is sub-picture, change your pic in style.css */ 
			$('body').addClass('sub-picture');
